  ...
  return (
    <div className='p-2 '>
      ...
      <div className='flex flex-col sm:w-2/3 gap-2  '>
        ...
        <div className='flex flex-col gap-2 bg-white p-4 rounded-lg border-red-500 border-2'>
          <button onClick={() => {setDel(!del); setConfirmText("")}} className={`${del ? "bg-blue-500 hover:bg-blue-600" : "bg-red-500 hover:bg-red-600"} 
          ...
          {del &&
            <>
                ...
                <p className='text-center text-blue-600 font-mono'>Enter your Email for confirmation</p>
